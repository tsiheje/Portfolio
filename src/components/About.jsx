...
const About = () => {
  return (
    <div className="w-full bg-gray-200 pt-24 px-20 box-border" id="about">
      <div className="flex items-center flex-wrap gap-5 w-full">
        ...
        <div className="w-3/5">
          ...
          <a href={cv} download className="flex items-center justify-center gap-2 bg-gradient-to-r from-blue-500 to-blue-300 w-1/4 text-center p-2.5 box-border rounded-md text-white text-lg mt-4">
            <p>Download CV</p>
            <img src={Down} alt=""/>
          </a>
        </div>
